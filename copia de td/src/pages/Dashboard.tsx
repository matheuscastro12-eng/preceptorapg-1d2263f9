      ...
      <div className="max-w-6xl mx-auto w-full">
        {showResult ? (
          ...
          <div className="animate-fade-up">
            {/* Header */}
            <div className="mb-6">
              <h2 className="font-['Manrope'] font-extrabold text-xl sm:text-2xl text-[#191c1d] tracking-tight">
                Estudo com IA
              </h2>
              <p className="text-[#6e7975] text-sm mt-0.5">
                Escolha o formato e descreva o tema para gerar conteúdo estruturado.
              </p>
            </div>
