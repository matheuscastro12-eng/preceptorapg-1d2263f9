...
- **PreceptorBook — Bloco Hema/Infecto/Gineco (12 drogas):** sulfato ferroso, ácido fólico, cianocobalamina (B12), oseltamivir, aciclovir, fluconazol, isoniazida, rifampicina, sulfato de magnésio, misoprostol, levonorgestrel (anticoncepção emergência), tenofovir.
- **PreceptorBook — Bloco ATB/Toxicologia (12 drogas):** ampicilina, oxacilina, gentamicina, amicacina, levofloxacino, albendazol, ivermectina, itraconazol, naloxona, flumazenil, N-acetilcisteína, ácido tranexâmico.
- **PreceptorBook — Bloco BZDs/Neuro/Osteo (12 drogas):** clonazepam, diazepam, lorazepam, alprazolam, zolpidem, bupropiona, mirtazapina, carbamazepina, lamotrigina, alendronato, colecalciferol (vit D3), carbonato de cálcio.
- **PreceptorBook — Bloco Onco/Hormonal/Oftalmo/Derma/Anest (14 drogas):** tamoxifeno, anastrozol, cisplatina, estradiol, progesterona micronizada, oxitocina, timolol colírio, latanoprosta, betametasona tópica, permetrina, lidocaína, succinilcolina, difenidramina, soro de reidratação oral.
- **PreceptorBook — Mega Bloco Hema/Eletr/Anest/Infecto/Endo (20 drogas):** UFH (heparina não-fracionada), vitamina K, gluconato de cálcio IV, KCl, bicarbonato de sódio, manitol, rocurônio, sugamadex, eritropoetina, atropina, valaciclovir, anfotericina B lipossomal, dolutegravir, cloroquina, praziquantel, metimazol, propiltiouracil (PTU), insulina glargina, insulina lispro, calcitriol. **Total: 179 drogas.**
- **PreceptorBook — Prescrições por doença (45):** agudas (12) — sepse, IAM com supra, anafilaxia, CAD, EHE, asma exacerbação, PAC, ITU, IC aguda/EAP, AVCi, status epilepticus, TEP/TVP; crônicas (17) — HAS, DM2, dislipidemia, FA, profilaxia TVP hospitalar, depressão, TAG, hipotireoidismo, Graves, DPOC, TB, asma manutenção, DRGE/úlcera, gota, AR, CINV, dor neuropática; saúde pública (6) — anemia ferropriva, influenza, TB pulmonar (RHZE), HIV PEP/PrEP, pré-eclâmpsia, planejamento familiar; **(10)** — PAC ambulatorial, verminose intestinal, intoxicação benzo/opioide, intoxicação paracetamol, hemorragia digestiva alta, insônia crônica, transtorno do pânico, epilepsia (1ª escolha por tipo), osteoporose pós-menopausa, abstinência alcoólica; **(5)** — CA mama RH+ adjuvante, dermatite atópica, glaucoma ângulo aberto, escabiose, diarreia aguda pediátrica; **(8 novas)** — hipercalemia, reversão anticoagulação, choque hipovolêmico, hipoglicemia, intoxicação organofosforado, malária (PNCM), esquistossomose mansônica, síndrome neuroléptica maligna / hipertermia maligna.
