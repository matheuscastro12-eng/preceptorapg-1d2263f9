...
- **PreceptorBook — Bloco BZDs/Neuro/Osteo (12 drogas):** clonazepam, diazepam, lorazepam, alprazolam, zolpidem, bupropiona, mirtazapina, carbamazepina, lamotrigina, alendronato, colecalciferol (vit D3), carbonato de cálcio. **Total: 145 drogas.**
- **PreceptorBook — Prescrições por doença (45):** agudas (12) — sepse, IAM com supra, anafilaxia, CAD, EHE, asma exacerbação, PAC, ITU, IC aguda/EAP, AVCi, status epilepticus, TEP/TVP; crônicas (17) — HAS, DM2, dislipidemia, FA, profilaxia TVP hospitalar, depressão, TAG, hipotireoidismo, Graves, DPOC, TB, asma manutenção, DRGE/úlcera, gota, AR, CINV, dor neuropática; saúde pública (6) — anemia ferropriva, influenza, TB pulmonar (RHZE), HIV PEP/PrEP, pré-eclâmpsia, planejamento familiar; **(10 novas)** — PAC ambulatorial, verminose intestinal, intoxicação benzo/opioide, intoxicação paracetamol, hemorragia digestiva alta, insônia crônica, transtorno do pânico, epilepsia (1ª escolha por tipo), osteoporose pós-menopausa, abstinência alcoólica.
