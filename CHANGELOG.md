...
- **PreceptorBook — Bloco Pneumo/GI/Reumato/Neuro (15 drogas):** tiotrópio, formoterol, fluticasona, montelucaste, pantoprazol, ondansetrona, metoclopramida, lactulose, polietilenoglicol, alopurinol, colchicina, metotrexato, hidroxicloroquina, gabapentina, pregabalina. **Total: 109 drogas.**
- **PreceptorBook — Prescrições por doença (29):** agudas (12) — sepse, IAM com supra, anafilaxia, CAD, EHE, asma exacerbação, PAC, ITU, IC aguda/EAP, AVCi, status epilepticus, TEP/TVP; crônicas (17) — HAS, DM2, dislipidemia, FA, profilaxia TVP hospitalar, depressão, TAG, hipotireoidismo, Graves, DPOC manutenção, TB, asma manutenção (GINA 2024), DRGE/úlcera, gota, AR (treat-to-target), CINV, dor neuropática.
