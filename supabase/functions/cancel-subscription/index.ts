...
serve(async (req) => {
  ...
  try {
    ...
    if (mode === "immediate") {
      ...
      return json({ success: true, mode: "immediate", message: "Assinatura cancelada agora. Acesso encerrado." });
    }
    ...
    return json({
      success: true,
      mode: "end_of_period",
      message: "Renovacao cancelada. Voce continua com acesso ate o fim do periodo atual.",
    });
  } catch (err) {
