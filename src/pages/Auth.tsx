...
const Auth = () => {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* Right Panel */}
      <div className="flex w-full flex-col items-center justify-center px-4 sm:px-6 py-8 sm:py-12 lg:w-[55%] bg-background relative">
                ...
                {migrationWarning && (
                  <div className="rounded-lg bg-red-50 border border-red-200 p-4 space-y-2">
                    ...
                    <p className="text-xs text-red-600 leading-relaxed">
                      Recentemente migramos nossa plataforma para uma nova infraestrutura. Se você já tinha conta no PreceptorMED, sua senha anterior não foi transferida por motivos de segurança. Por favor, clique em <strong>"Esqueci minha senha"</strong> abaixo para criar uma nova senha.
                    </p>
                    <button
                      type="button"
