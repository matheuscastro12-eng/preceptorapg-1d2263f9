  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 relative">
        <section className="container px-4 py-16 md:py-24">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
              <Button 
                size="lg" 
                className="glow-medical text-lg px-8"
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {features.map((feature, index) => (
                <div 
                  key={index} 
                  className="glass rounded-2xl p-6 border border-border/50 hover-lift"
                >
        ...
        {/* Benefits Section */}
        <section className="container px-4 py-16">
          <div className="max-w-3xl mx-auto glass rounded-3xl p-8 md:p-12 border border-primary/20">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {benefits.map((benefit, index) => (
                <div key={index} className="flex items-center gap-3 p-4 rounded-xl bg-background/50">
